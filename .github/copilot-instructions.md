...
## File Organization
- **`.github/`** - all guideline and instruction files for agents and contributors
- **`docs/todos/`** - all plans, roadmaps, and TODO documents
- **`docs/notes/`** - explanations, design notes, and other documentation
- **`docs/`** - other documentation that doesn't fit the above categories
- **`./templates/`** subdirectories contain `.tpp` files with template implementations (one `.tpp` per header file with same base name)
...
- generate docs of newly declared classes in the format specified in docs.instructions.md
