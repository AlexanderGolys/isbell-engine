...
/*
 * Primitive meshes (triangles, quads, disks, icospheres, icosahedra, boxes, particles)
 */
...
/*
 * @brief: 3D curve with a given width
 */
/**
 * @parblock
 * Parametric surfaces
...
/*
 * Classes of examples, TODO: remove this from here
 */
