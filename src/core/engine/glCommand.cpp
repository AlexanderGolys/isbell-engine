...
void GLCommand::setUniform(gl_uniform_loc location, raw_data_ptr data, GLSLType type, array_len arraySize) {
	THROW_IF(not supportedUniformType(type), ValueError, "Unsupported GLSLType for uniform setting.");
	switch (type) {
	case FLOAT:
		glUniform1fv(location, arraySize, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case VEC2:
		glUniform2fv(location, arraySize, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case VEC3:
		glUniform3fv(location, arraySize, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case VEC4:
		glUniform4fv(location, arraySize, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT2:
		glUniformMatrix2fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT3:
		glUniformMatrix3fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT4:
		glUniformMatrix4fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case INT:
		glUniform1iv(location, arraySize, reinterpret_cast<data_ptr<GLint>>(data)); break;
	case IVEC2:
		glUniform2iv(location, arraySize, reinterpret_cast<data_ptr<GLint>>(data)); break;
	case IVEC3:
		glUniform3iv(location, arraySize, reinterpret_cast<data_ptr<GLint>>(data)); break;
	case IVEC4:
		glUniform4iv(location, arraySize, reinterpret_cast<data_ptr<GLint>>(data)); break;
	case UINT:
		glUniform1uiv(location, arraySize, reinterpret_cast<data_ptr<GLuint>>(data)); break;
	case BOOL:
		glUniform1iv(location, arraySize, reinterpret_cast<data_ptr<GLint>>(data)); break;
	case MAT2x3:
		glUniformMatrix2x3fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT2x4:
		glUniformMatrix2x4fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT3x2:
		glUniformMatrix3x2fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT3x4:
		glUniformMatrix3x4fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT4x2:
		glUniformMatrix4x2fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	case MAT4x3:
		glUniformMatrix4x3fv(location, arraySize, GL_FALSE, reinterpret_cast<data_ptr<GLfloat>>(data)); break;
	default:
...
void GLCommand::setUniform(gl_uniform_loc location, unsigned int value) {
...
void GLCommand::pointAtAttributeBuffer(int inputNumber, gl_id bufferAddress, GLSLType type, byte_size stride,  raw_data_ptr offset) {
	THROW_IF(currentVAO == 0, RuntimeError, "No VAO is currently bound.");
