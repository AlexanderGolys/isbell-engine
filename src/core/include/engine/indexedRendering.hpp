...
public:
	...
	int addFullVertexData(const Vertex3DSmart& v);
	...
	Vertex3DSmart getVertex(int index) const;
...
public:
	...
	BufferedVertex(BufferManager& bufferBoss, const Vertex3DSmart& v);
	...
	void setVertex(const Vertex3DSmart& v);
};
...
public:
	...
	Vertex3DSmart getVertex(int i) const;
...
public:
	...
	IndexedMesh();
	IndexedMesh(const vector<Vertex3DSmart>& hardVertices, const vector<ivec3>& faceIndices, const PolyGroupID& id);
	...
	void addNewPolygroup(const vector<Vertex3DSmart>& hardVertices, const vector<ivec3>& faceIndices, const PolyGroupID& id);
	...
	vector<Vertex3DSmart> getVertices(const PolyGroupID& id) const;
